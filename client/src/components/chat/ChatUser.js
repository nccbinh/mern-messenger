...
export default function ChatUser({ name, message, unread, online, avatar, clickHandler }) {
            ...
            <Box onClick={clickHandler} className={classes.chatUser}>
                {online ?
                    <OnlineBadge
                        ...
                        variant="dot"
                    ><Avatar src={avatar} alt="" className={classes.avatar} /></OnlineBadge>
                    :
                    <Avatar src={avatar} alt="" className={classes.avatar} />
                }
                <div>
                    <Typography className={classes.chatName}>{name}</Typography>
                    <Typography className={classes.chatPreview + " " + (unread ? classes.chatUnread : "")}>
                        {message}
                    </Typography>
                </div>
            </Box>
